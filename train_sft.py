...
def load_model_weights(model, checkpoint_path: str, device: str):
...
def train(args):
    ...
    if args.pretrained_checkpoint:
        loaded_step = load_model_weights(
            model=model,
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="data/raw/sft_sample.jsonl")
